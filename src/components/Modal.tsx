...
export function Modal({
  ...
  const buttonColors = {
    ...
    warning: "bg-orange-600 hover:bg-orange-500 text-white shadow-orange-500/20",
  };
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
          ...
          <motion.div
            ...
            className="relative w-full max-w-md bg-card rounded-[2.5rem] shadow-[0_40px_80px_-20px_rgba(0,0,0,0.15)] dark:shadow-[0_40px_80px_-20px_rgba(0,0,0,0.6)] overflow-hidden border border-border"
          >
            <div className="p-6">

    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-black text-foreground tracking-tight uppercase">Reporte de Faltantes</h1>
            <p className="text-slate-500 text-[10px] font-black uppercase tracking-widest mt-0.5">Listado histórico de personal sin registros cargados.</p>
          </div>
        </div>
        <button
      ...
      <div className="bg-card/40 p-6 rounded-[2.5rem] border border-border shadow-2xl space-y-4 backdrop-blur-xl">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="space-y-2">
            <label className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] ml-1 flex items-center gap-2 group">
              <Calendar className="w-3 h-3 group-hover:text-accent-gold transition-colors" /> Fecha Hasta <span className="text-[8px] opacity-40 font-black tracking-tight">(OPCIONAL)</span>
            </label>
            <input
              type="date"
              value={fechaHasta}
